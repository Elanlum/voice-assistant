...
from voice_assistant.bin.initialize.cache import cache, get_params_from_cache, get_language_from_cache, is_language_ru
...
def reply_weather(city):
    ...
    cache[CITY_LOCAL_NAME] = translate_en_ru(city) if is_language_ru() else city
